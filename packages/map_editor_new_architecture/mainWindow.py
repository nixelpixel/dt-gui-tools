...
from map_editor_new_architecture.triggerHandlers import TriggerHandlers
from windowDesign import *

# pyuic5 main_design.ui -o main_design.py
from map_editor_new_architecture.mapViewer import MapViewer
...
class DuckWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, args, elem_info="doc/info.json"):
        ...
        self.triggers_handler = TriggerHandlers(args)
